...
export default {
    ...
    chartOptions: {
      ...
      fill: {
        ...
        gradient: {
          shade: 'dark',
          inverseColors: false,
          gradientToColors: ['#336ba8', '#b8c2cc'],
          shadeIntensity: 1,
          type: 'horizontal',
          opacityFrom: 1,
          opacityTo: 1,
  ...
  salesBar: {
    ...
    chartOptions: {
      ...
      colors: ['rgba(115,103,240,0.15)', 'rgba(115,103,240,0.15)', '#336ba8', 'rgba(115,103,240,0.15)', 'rgba(115,103,240,0.15)', 'rgba(115,103,240,0.15)'],
      plotOptions: {
        bar: {
          columnWidth: '45%',
          distributed: true,
