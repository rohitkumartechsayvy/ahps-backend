      ...
      <div class="vx-col w-full lg:w-1/2 mb-base">
        ...
        >
          ...
          <p class="xl:w-3/4 lg:w-4/5 md:w-2/3 w-4/5 mx-auto text-white">
            You have done
            <strong>{{ checkpointReward.progress }}</strong> more sales today.
  ...
  created() {
    ...
    this.$http
      ...
      .then((response) => {
        ...
        console.log("checkpointReward", checkpointReward);
      })
      .catch((error) => {
        console.log(error);
      });
    ...
    this.$http
      .get("/api/user-gain")
      .then((response) => {
        this.subscribersGained = response.data.response.subscribers_gained;
      })
      .catch((error) => {
        console.log(error);
      });
