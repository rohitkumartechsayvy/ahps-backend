...
export default {
  ...
  methods: {
    ...
    save_changes() {
      ...
      console.log(this.data_local.user_id);
      this.$store
        .dispatch("accountantManagement/updateAccountant", this.data_local)
        .then((res) => {
          console.log("Notifications");
          this.$vs.notify({
            color: "success",
            title: "Information Updated",
            text: "Accountant information updated successfully!",
          });
        })
        .catch((err) => {
    ...
    updatePassword() {
      ...
      console.log("obj", obj);
      this.$store
        .dispatch("accountantManagement/updateNewPassword", obj)
        .then((res) => {
          if (
            res &&
