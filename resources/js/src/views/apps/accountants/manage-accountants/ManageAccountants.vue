          ...
          <vs-dropdown vs-trigger-click class="cursor-pointer">
            ...
            >
              <span class="mr-2"
                ...
                -
                {{
                  accountantsData.length - currentPage * paginationPageSize > 0
                    ? currentPage * paginationPageSize
                    : accountantsData.length
                }}
                of {{ accountantsData.length }}</span
              >
...
export default {
  ...
  computed: {
    accountantsData() {
      console.log(
        "this.$store.state.accountantManagement",
        this.$store.state.accountantManagement
      );
      return this.$store.state.accountantManagement.accountants;
    },
    paginationPageSize() {
  ...
  created() {
    ...
    this.$store
      .dispatch("accountantManagement/fetchAccountants")
      .catch((err) => {
        console.error(err);
      });
  },
