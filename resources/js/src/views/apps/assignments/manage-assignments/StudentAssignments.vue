...
export default {
  ...
  computed: {
    syllabusData() {
      console.log(this.$store.state.assignmentManagement.assignments);
      this.assignments_data = this.$store.state.assignmentManagement.assignments;
      return this.$store.state.assignmentManagement.assignments;
    },
    paginationPageSize() {
  ...
  methods: {
    ...
    save_changes() {
      if (this.image) {
        ...
        this.$store
          .dispatch("syllabusManagement/submitAssignment", formData)
          .then((res) => {
            if (
              res &&
  ...
  created() {
    ...
    this.$store
      .dispatch("assignmentManagement/fetchStudentAssignments", studentId)
      .then((res) => {
