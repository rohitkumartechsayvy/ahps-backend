...
<template>
  <div id="page-user-list">
    ...
    >
      <span
        >Assigned Classes to Teacher ID: {{ $route.params.teacherId }} not
        found.</span
      >
    </vs-alert>
          ...
          <vs-dropdown vs-trigger-click class="cursor-pointer">
            ...
            >
              <span class="mr-2"
                ...
                -
                {{
                  assignedData.length - currentPage * paginationPageSize > 0
                    ? currentPage * paginationPageSize
                    : assignedData.length
                }}
                of {{ assignedData.length }}</span
              >
...
export default {
  ...
  computed: {
    assignedData() {
      return this.$store.state.classManagement.assigned_classes;
    },
    paginationPageSize() {
