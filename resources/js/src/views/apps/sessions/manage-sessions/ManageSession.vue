          ...
          <vs-dropdown vs-trigger-click class="cursor-pointer">
            ...
            >
              <span class="mr-2"
                ...
                -
                {{
                  sessionsData.length - currentPage * paginationPageSize > 0
                    ? currentPage * paginationPageSize
                    : sessionsData.length
                }}
                of {{ sessionsData.length }}</span
              >
...
export default {
  ...
  computed: {
    sessionsData() {
      console.log(this.$store.state.sessionManagement.sessions);
      return this.$store.state.sessionManagement.sessions;
    },
    paginationPageSize() {
  ...
  created() {
    ...
    this.$store.dispatch("sessionManagement/fetchSessions").catch((err) => {
      console.error(err);
    });
  },
};
