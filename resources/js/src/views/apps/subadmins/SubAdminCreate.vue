...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      if (!this.errors.any()) {
        this.$store
          .dispatch("subAdminManagement/saveSubAdmin", this.data_local)
          .then((res) => {
            console.log("res", res);
            if (res.data.response) {
              ...
              this.$router.push({ path: "/manage-subadmins" });
            } else {
  ...
  created() {
    ...
    if (!moduleSubAdminManagement.isRegistered) {
      this.$store.registerModule(
        "subAdminManagement",
        moduleSubAdminManagement
      );
      moduleSubAdminManagement.isRegistered = true;
    }
