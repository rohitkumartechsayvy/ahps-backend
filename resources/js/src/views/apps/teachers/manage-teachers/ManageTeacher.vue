...
import CellRendererTimeTable from "./cell-renderer/CellRendererTimeTable.vue";
...
export default {
    ...
    return {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          filter: true,
          width: 150,
          cellRendererFramework: "CellRendererTimeTable",
        },
        {
          headerName: "Status",
          field: "status",
  ...
  computed: {
    usersData() {
      console.log(
        "this.$store.state.userManagement.teachers",
        this.$store.state.userManagement.teachers
      );
      return this.$store.state.userManagement.teachers;
    },
    paginationPageSize() {
