...
<script>
import moduleTeacherManagement from "@/store/teacher-management/moduleTeacherManagement.js";
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      if (!this.errors.any()) {
        this.$store
          .dispatch("teacherManagement/saveTeacher", this.data_local)
          .then((res) => {
            console.log("res", res);
            if (res.data.response) {
              ...
              this.$router.push({ path: "/manage-teachers" });
            } else {
  ...
  created() {
    ...
    if (!moduleTeacherManagement.isRegistered) {
      this.$store.registerModule("teacherManagement", moduleTeacherManagement);
      moduleTeacherManagement.isRegistered = true;
    }
    const userId = this.$route.params.userId;
    this.$store
      .dispatch("teacherManagement/fetchUser", userId)
      .then((res) => {
