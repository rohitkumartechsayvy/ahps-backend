...
export default {
  ...
  computed: {
    itemsData() {
      console.log("itemManagement");
      console.log(this.$store.state.itemManagement);
  ...
  created() {
    ...
    this.$store.dispatch("itemManagement/fetchAllItems").catch((err) => {
      console.error(err);
    });
    this.$store.dispatch("itemManagement/soldItems").catch((err) => {
      console.error(err);
    });
  },
};
