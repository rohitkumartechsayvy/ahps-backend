          ...
          <vs-dropdown vs-trigger-click class="cursor-pointer">
            ...
            >
              <span class="mr-2"
                ...
                -
                {{
                  subjectsData.length - currentPage * paginationPageSize > 0
                    ? currentPage * paginationPageSize
                    : subjectsData.length
                }}
                of {{ subjectsData.length }}</span
              >
...
export default {
  ...
  computed: {
    subjectsData() {
      console.log(this.$store.state.subjectManagement.subjects);
  ...
  created() {
    ...
    if (this.$route.params.classId) {
      ...
      this.$store.dispatch("subjectManagement/fetchSubjects").catch((err) => {
        console.error(err);
      });
    }
  },
