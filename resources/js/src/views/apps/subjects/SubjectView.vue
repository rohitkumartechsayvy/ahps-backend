        ...
        <div class="vx-row">
          ...
          <div class="vx-col" id="avatar-col">
            <div class="img-container mb-4">
              <img :src="subject_data.avatar" class="rounded w-full" />
            </div>
          </div>
          ...
          <div class="vx-col flex-1" id="account-info-col-2">
            <table>
              <tr>
                ...
                <td>{{ subject_data.status }}</td>
              </tr>
              <tr>
                <td class="font-semibold">Role</td>
                <td>{{ subject_data.role }}</td>
              </tr>
            </table>
          </div>
          <!-- /Information - Col 2 -->
          ...
          <vx-card title="Information" class="mb-base">
            <table>
              <tr>
                ...
                <td>{{ subject_data.dob }}</td>
              </tr>
              <tr>
                <td class="font-semibold">Mobile</td>
                <td>{{ subject_data.mobile }}</td>
              </tr>
              <tr>
                <td class="font-semibold">Website</td>
                <td>{{ subject_data.website }}</td>
              </tr>
              <tr>
                <td class="font-semibold">Languages</td>
                <td>{{ subject_data.languages_known.join(", ") }}</td>
              </tr>
              <tr>
                <td class="font-semibold">Gender</td>
                <td>{{ subject_data.gender }}</td>
              </tr>
              <tr>
                <td class="font-semibold">Contact</td>
                <td>{{ subject_data.contact_options.join(", ") }}</td>
              </tr>
            </table>
          </vx-card>
        </div>
          ...
          <vx-card title="Social Links" class="mb-base">
            <table>
              <tr>
                ...
                <td>{{ subject_data.social_links.twitter }}</td>
              </tr>
              <tr>
                <td class="font-semibold">Facebook</td>
                <td>{{ subject_data.social_links.facebook }}</td>
              </tr>
              <tr>
                <td class="font-semibold">Instagram</td>
                <td>{{ subject_data.social_links.instagram }}</td>
              </tr>
              <tr>
                <td class="font-semibold">Github</td>
                <td>{{ subject_data.social_links.github }}</td>
              </tr>
              <tr>
                <td class="font-semibold">CodePen</td>
                <td>{{ subject_data.social_links.codepen }}</td>
              </tr>
              <tr>
                <td class="font-semibold">Slack</td>
                <td>{{ subject_data.social_links.slack }}</td>
              </tr>
            </table>
          </vx-card>
        </div>
      ...
      <vx-card>
        ...
        <div class="block overflow-x-auto">
          <table class="w-full permissions-table">
            ...
            <tr v-for="(val, name) in subject_data.permissions" :key="name">
...
export default {
  ...
  methods: {
    ...
    deleteRecord() {
      ...
      // this.$store.dispatch("SubjectManagement/removeRecord", this.subject_data.id)
  ...
  created() {
    ...
    this.$store
      .dispatch("SubjectManagement/fetchUser", userId)
      .then((res) => {
