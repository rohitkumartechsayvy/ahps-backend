          ...
          <vs-dropdown vs-trigger-click class="cursor-pointer">
            ...
            >
              <span class="mr-2"
                ...
                -
                {{
                  contactsData.length - currentPage * paginationPageSize > 0
...
import CellRendererQuery from "./cell-renderer/CellRendererQuery.vue";
...
export default {
      ...
      columnDefs: [
        {
          ...
          cellRendererFramework: "CellRendererQuery",
        },
        {
          headerName: "Name",
          field: "name",
  ...
  computed: {
    contactsData() {
      ...
      return this.$store.state.contactManagement.queries;
    },
    paginationPageSize() {
  ...
  created() {
    ...
    this.$store.dispatch("contactManagement/fetchAllQueries").catch((err) => {
      console.error(err);
    });
  },
};
