          ...
          <vs-dropdown vs-trigger-click class="cursor-pointer">
            ...
            >
              <span class="mr-2"
                ...
                -
                {{
                  syllabusesData.length - currentPage * paginationPageSize > 0
                    ? currentPage * paginationPageSize
                    : syllabusesData.length
                }}
                of {{ syllabusesData.length }}</span
              >
...
export default {
  ...
  created() {
    ...
    this.$store.dispatch("syllabusManagement/fetchSyllabuses").catch((err) => {
      console.error(err);
    });
  },
};
