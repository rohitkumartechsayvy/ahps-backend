      ...
      <div class="vx-col md:w-1/2 w-full">
        <div class="mt-4">
          ...
          <v-select
            ...
            v-model="data_local.syllabus_status"
            :clearable="false"
  ...
  methods: {
    ...
    save_changes() {
      ...
      let obj = {
        ...
        syllabus_status: this.data_local.syllabus_status.value,
      };
      this.$store
        .dispatch("syllabusManagement/updateSyllabus", obj)
        .then((res) => {
          console.log("Notifications");
          this.$vs.notify({
            color: "success",
            title: "Information Updated",
            text: "Syllabus information updated successfully!",
          });
        })
        .catch((err) => {
    ...
    delete() {
      ...
      console.log("data_local", this.data_local);
      this.$store
        .dispatch("syllabusManagement/updateSyllabus", this.data_local)
        .then((res) => {
          console.log("Notifications");
          this.$vs.notify({
            color: "success",
