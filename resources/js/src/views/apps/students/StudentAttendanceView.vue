  ...
  <div id="simple-calendar-app">
    <div class="vx-card no-scroll-content">
      <calendar-view
        ...
        :show-date="showDate"
        :events="simpleCalendarEvents.attendanceData"
            ...
            <div class="vx-col w-full flex">
              ...
              <div class="flex flex-wrap sm:justify-start justify-center">
                ...
                <span class="font-semibold mr-2">
                  Total Count -
                  {{ simpleCalendarEvents.attendanceData.length }}
                </span>
                <div
                ...
                >
                  ...
                  ></div>
                  <span class="font-semibold" v-if="label.color == 'danger'">
                    {{ label.text }} -
                    {{ simpleCalendarEvents.absent.length }}
                  </span>
                  <span
                    class="font-semibold"
                    v-else-if="label.color == 'success'"
                    >{{ label.text }} -
                    {{ simpleCalendarEvents.present.length }}
                  </span>
                  <span
                    class="font-semibold"
                    v-else-if="label.color == 'warning'"
                    >{{ label.text }} -
                    {{ simpleCalendarEvents.leave.length }}
                  </span>
                </div>
...
import moduleAttendanceManagement from "@/store/attendance-management/moduleAttendanceManagement.js";
...
export default {
  ...
  computed: {
    simpleCalendarEvents() {
      console.log(
        "this.$store.state.attendanceManagement.attendance_events",
        this.$store.state.attendanceManagement.attendance_events
      );
      return this.$store.state.attendanceManagement.attendance_events;
    },
    validForm() {
      return (
        this.title !== "" &&
    ...
    calendarLabels() {
      console.log(
        "this.$store.state.calendar.eventLabels",
        this.$store.state.calendar.eventLabels
      );
  ...
  created() {
    ...
    if (!moduleAttendanceManagement.isRegistered) {
      this.$store.registerModule(
        "attendanceManagement",
        moduleAttendanceManagement
      );
      moduleAttendanceManagement.isRegistered = true;
    }
    console.log("this.$route.params.studentId", this.$route.params.studentId);
    this.$store.dispatch(
      "attendanceManagement/fetchStudentAttendance",
