        ...
        <div class="vx-row mb-6">
          ...
          <div class="vx-col sm:w-2/3 w-full">
            <vs-radio v-model="data_local.category" vs-value="1" class="mr-4"
              >General</vs-radio
            >
            <vs-radio v-model="data_local.category" vs-value="2" class="mr-4"
              >OBC</vs-radio
            >
...
export default {
  ...
  data() {
    return {
      data_local: {
        ...
        father_id: null,
        nationality: null,
        staff_child: { label: "No", value: "no" },
        adhaar_card: null,
        transfer_certificate: { label: "No", value: "no" },
        migration_certificate: { label: "No", value: "no" },
        birth_certificate: { label: "No", value: "no" },
        marksheet_certificate: { label: "No", value: "no" },
        adhaar_card_certificate: { label: "No", value: "no" },
        parent_id: null,
        parent_type: null,
        student_class: { label: null, value: null },
        admission_no: null,
        roll_no: null,
        category: null,
        last_school: null,
  ...
  computed: {
    ...
    transfer_local: {
      get() {
        return {
          label: this.capitalize(this.data_local.transfer_certificate),
          value: this.data_local.transfer_certificate,
        };
      },
      set(obj) {
        this.data_local.transfer_certificate = obj.value;
      },
    },
    migration_local: {
      get() {
        return {
          label: this.capitalize(this.data_local.migration_certificate),
          value: this.data_local.migration_certificate,
        };
      },
      set(obj) {
        this.data_local.migration_certificate = obj.value;
      },
    },
    birth_local: {
      get() {
        return {
          label: this.capitalize(this.data_local.birth_certificate),
          value: this.data_local.birth_certificate,
        };
      },
      set(obj) {
        this.data_local.birth_certificate = obj.value;
      },
    },
    marksheet_local: {
      get() {
        return {
          label: this.capitalize(this.data_local.marksheet_certificate),
          value: this.data_local.marksheet_certificate,
        };
      },
      set(obj) {
        this.data_local.marksheet_certificate = obj.value;
      },
    },
    adhaar_card_local: {
      get() {
        return {
          label: this.capitalize(this.data_local.adhaar_card_certificate),
          value: this.data_local.adhaar_card_certificate,
        };
      },
      set(obj) {
        this.data_local.adhaar_card_certificate = obj.value;
      },
    },
    parent_local: {
      get() {
  ...
  methods: {
    ...
    onImageChange(e) {
      ...
      formData.append("adhaar_card", this.image, this.image.name);
      this.$store
        .dispatch("assignmentManagement/submitAadhar", formData)
        .then((res) => {
          this.data_local.adhaar_card = res.data.response;
        })
        .catch((err) => {
          console.error(err);
        });
    ...
    submitForm() {
      ...
      /*
      let formData = new FormData();
      formData.append("adhaar_card", this.image);
      formData.append("name", this.data_local.name);
      formData.append("email", this.data_local.email);
      formData.append("phone_number", this.data_local.phone_number);
      formData.append("father_name", this.data_local.father_name);
      formData.append("mother_name", this.data_local.mother_name);
      formData.append("password", this.data_local.password);
      formData.append(
        "staff_child",
        this.data_local.staff_child.value == "yes" ? 2 : 1
      );
      formData.append(
        "father_id",
      ...
      formData.append("dob", this.data_local.dob);
      formData.append("student_class", this.data_local.student_class.value);
      console.log("save student formData", formData); */
      let obj = {
      ...
      if (!this.errors.any()) {
        this.$store
          .dispatch("studentManagement/saveStudent", obj)
          .then((res) => {
            console.log("res", res);
