...
export default {
  ...
  computed: {
    ChargesData() {
      console.log(this.$store.state.tuitionFeeManagement.charges);
      return this.$store.state.tuitionFeeManagement.charges;
    },
    paginationPageSize() {
  ...
  created() {
    ...
    this.$store.dispatch("tuitionFeeManagement/fetchCharges").catch((err) => {
      console.error(err);
    });
  },
};
