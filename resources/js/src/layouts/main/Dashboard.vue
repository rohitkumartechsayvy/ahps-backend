...
let role = store.state.AppActiveUser.user_type;
import BackToTop from "vue-backtotop";
import HNavMenu from "@/layouts/components/horizontal-nav-menu/NewHorizontalNavMenu.vue";
import navMenuItems from "@/layouts/components/vertical-nav-menu/NewNavMenuItems.js";
// import SubNavMenuItems from "@/layouts/components/vertical-nav-menu/SubadminNavMenuItems.js";
// import AccountantMenuItems from "@/layouts/components/vertical-nav-menu/AccountantNavMenuItems.js";
// import StudentMenuItems from "@/layouts/components/vertical-nav-menu/StudentNavMenuItems.js";
// import TeacherMenuItems from "@/layouts/components/vertical-nav-menu/TeacherNavMenuItems.js";
...
console.log("generated Menu", store.state.AppActiveUser);
console.log("generated Menu2", state);
...
export default {
  ...
  data() {
    return {
      ...
      themeTitle: process.env.MIX_APP_NAME,
      steps: [
        {
